...
describe('prop', function() {
  ...
  it('shows the same behaviour as path for a nonexistent property', function() {
    ...
    var pathResult = R.pathOr(fred, ['incorrect'], undefined);
